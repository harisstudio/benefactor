...
const translations: Record<Language, Translations> = {
  English: {
    ...
    heroDesc: "Start in minutes. Create your story and share it with the world using our easy fundraising tools.",
  ...
  Türkçe: {
    ...
    heroDesc: "Dakikalar içinde başlayın. Hikayenizi oluşturun ve kolay bağış araçlarımızla dünyayla paylaşın.",
