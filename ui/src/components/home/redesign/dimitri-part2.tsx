  ...
  return (
    <section className="relative overflow-hidden bg-bg-off-white border-t border-surface-muted">
      ...
      <div className="relative max-w-[1280px] mx-auto px-5 sm:px-8 lg:px-[clamp(40px,5vw,120px)] py-16 md:py-24">
        ...
        {/* Language switcher: 2×2 grid on mobile (EN | LT / RU | TR), one
            row on larger screens. The dub choice applies to both clips. */}
        ...
        >
          {/* Portrait (phone-format) clip — left column on desktop, shown
              second on mobile so the landscape Part 2 clip (the main
              narrated story) leads the section. */}
          <div className="order-2 lg:order-1 relative rounded-[28px] border border-surface-muted shadow-xl overflow-hidden bg-primary-navy max-w-[260px] w-full mx-auto lg:max-w-none lg:mx-0 lg:h-full">
          ...
          {/* Landscape Part 2 clip — right column on desktop, leads the
              stack on mobile. */}
          <div className="order-1 lg:order-2 relative rounded-[28px] border border-surface-muted shadow-xl overflow-hidden bg-primary-navy lg:h-full">
