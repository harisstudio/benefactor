      ...
      <div className="border-t border-white/10">
        <div className="max-w-container mx-auto px-5 py-5 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div className="flex flex-col md:flex-row md:items-center gap-3">
            <span className="text-sm text-gray-300">&copy; 2026 Benefactor Team</span>
            <div className="flex flex-wrap gap-x-4 gap-y-1">
              {legalLinks.map((label) => (
                <Link key={label} href="#" className="text-xs text-gray-400 hover:text-white transition-colors">
                  {label}
                </Link>
              ))}
            </div>
